...
class Settings:
    ...
    # PSX backend - default to public Render deployment, override via env for staging.
    psx_base_url: str = os.getenv(
        "PYPSX_BASE_URL",
        "https://pypsx-library.onrender.com",
    )
    ...
    # Backend URL (default production deployment)
    backend_url: str = os.getenv("PYTRADER_BACKEND_URL", "https://pytrader-backend.onrender.com")
